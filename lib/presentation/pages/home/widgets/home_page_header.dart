...
import 'package:aerium/utills/common_widgets.dart';
              ...
              return Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    margin: imageMargin,
                      child: Lottie.asset(ImagePath.Lottie_animation,),
                    /* child: AnimatedSlideTranstion(
                      controller: controller,
                      position: animation,
                      child: Stack(
...
class _AboutDevState extends State<AboutDev> {
      ...
      children: [
        ...
        AnimatedPositionedWidget(
          ...
          child: AnimatedBubbleButton(
            ...
            imageColor: Color.fromARGB(255, 0, 0, 0),
            ...
            onTap: () {
               CommonWidgets().showCoumingSoonToast();
  ...
  List<Widget> _buildSocials({
    ...
    TextTheme textTheme = Theme.of(context).textTheme;
    TextStyle? style = textTheme.bodyText1?.copyWith(color: AppColors.primaryTextColor);
    ...
    for (int index = 0; index < data.length; index++) {
      items.add(
        AnimatedLineThroughText(
          coverColor: AppColors.primaryTextColor,
